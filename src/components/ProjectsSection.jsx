...
const projects = [
  {
    ...
    description: "A multi model comparison of student marks prediction using various parameters.",
    video: "/projects/project1.mp4", 
    tags: ["Python", "MLOps", "Html", "CSS", "JavaScript"],
      ...
      <div className="container mx-auto max-w-5xl">
              ...
              <div className="h-48 overflow-hidden flex items-center justify-center bg-black">
                {project.video ? (
                  <video
                    ...
                    poster={project.image} // fallback poster if you want
                  />
                ) : (
                  <img
                    src={project.image}
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            href="https://github.com/DevSourcerer04?tab=repositories"
          >
